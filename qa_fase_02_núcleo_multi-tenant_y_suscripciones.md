# Plan de pruebas — Fase 2: Núcleo multi-tenant y suscripciones

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Aislamiento por restaurante, Global Scope, middleware owner y suscripción.
...
### QA-F02-001 — Crear dos restaurantes y comprobar que un owner no lista, lee ni modifica recursos del otro.
...
### QA-F02-002 — Comprobar que una suscripción vencida o suspendida bloquea operaciones de escritura.
...
### QA-F02-003 — Verificar que el superadmin conserva visibilidad global exclusivamente donde proceda.

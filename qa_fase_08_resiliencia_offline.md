# Plan de pruebas — Fase 8: Resiliencia offline

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Heartbeat, IndexedDB/Dexie, UUID e importación idempotente.
...
### QA-F08-001 — Forzar estado offline, guardar operaciones locales y comprobar que no se pierden al recargar.
...
### QA-F08-002 — Restablecer red y sincronizar lote con UUIDs sin crear duplicados.
...
### QA-F08-003 — Simular respuesta parcial o error temporal y verificar reintentos seguros.

# Plan de pruebas — Fase 10: Despliegue y monitorización

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: CI/CD, health checks, errores y copias cifradas.
...
### QA-F10-001 — Ejecutar pipeline de CI con tests backend y build frontend.
...
### QA-F10-002 — Verificar health checks, registro de excepciones y alertas operativas.
...
### QA-F10-003 — Crear, cifrar, restaurar y verificar una copia de seguridad en entorno aislado.

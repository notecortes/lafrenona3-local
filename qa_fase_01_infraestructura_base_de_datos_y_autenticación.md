# Plan de pruebas — Fase 1: Infraestructura, base de datos y autenticación

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Docker, Laravel 11, MySQL, Redis, migraciones y Sanctum.
...
### QA-F01-001 — Levantar los contenedores y comprobar que backend, MySQL y Redis responden.
...
### QA-F01-002 — Ejecutar migraciones desde cero y verificar claves foráneas, índices y restricciones.
...
### QA-F01-003 — Autenticar un usuario válido y confirmar que recibe un token Sanctum.
...
### QA-F01-004 — Rechazar credenciales erróneas sin filtrar información sensible.

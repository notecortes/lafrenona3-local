# Plan de pruebas — Fase 18: CRUD Admin y Owner

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Formularios Vue, roles, validación, API y WCAG 2.1 AA.
...
### QA-F18-001 — Validar formularios de owners, restaurantes, suscripciones y personal antes de llamar a API.
...
### QA-F18-002 — Comprobar roles permitidos, contraseña mínima y errores de API visibles y accesibles.
...
### QA-F18-003 — Ejecutar navegación por teclado y lector de pantalla sobre todos los formularios.

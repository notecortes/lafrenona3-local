# Plan de pruebas — Fase 3: CRUD del propietario

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Categorías, productos, mesas y operaciones de owner.
...
### QA-F03-001 — Completar el flujo principal de la fase desde la interfaz y validar la respuesta API.
...
### QA-F03-002 — Enviar datos inválidos, incompletos y no autorizados; verificar errores controlados.
...
### QA-F03-003 — Confirmar persistencia, aislamiento por restaurante y ausencia de regresiones visibles.

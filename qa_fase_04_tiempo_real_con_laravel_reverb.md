# Plan de pruebas — Fase 4: Tiempo real con Laravel Reverb

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Eventos, canales públicos/privados y autorización WebSocket.
...
### QA-F04-001 — Autorizar el acceso a canales privados solo al personal del restaurante correspondiente.
...
### QA-F04-002 — Emitir y recibir eventos de creación de pedido, cambio de estado y liberación de mesa.
...
### QA-F04-003 — Reconectar un cliente WebSocket sin duplicar listeners ni eventos visuales.

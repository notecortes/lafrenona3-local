# Plan de pruebas — Fase 13: Sala y alertas

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Llamada de camarero, cuenta, mapa de sala y WebSockets.
...
### QA-F13-001 — Enviar llamada y solicitud de cuenta con sesión QR válida.
...
### QA-F13-002 — Comprobar alerta reactiva visible en Room Dashboard y limpieza al atenderla.
...
### QA-F13-003 — Rechazar peticiones de mesas o sesiones que no correspondan.

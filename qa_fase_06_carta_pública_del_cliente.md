# Plan de pruebas — Fase 6: Carta pública del cliente

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: PWA, QR, carta, rendimiento, i18n y accesibilidad.
...
### QA-F06-001 — Abrir la carta desde móvil usando sesión de mesa válida y rechazar token inválido.
...
### QA-F06-002 — Validar contraste, foco visible, etiquetas accesibles y navegación por teclado.
...
### QA-F06-003 — Verificar el presupuesto de carga y funcionamiento básico como PWA.

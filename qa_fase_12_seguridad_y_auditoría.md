# Plan de pruebas — Fase 12: Seguridad y auditoría

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Audit logs, rate limiting, autorización y trazabilidad.
...
### QA-F12-001 — Generar acciones críticas y comprobar registro de actor, tenant, antes/después y fecha.
...
### QA-F12-002 — Intentar modificar o consultar logs ajenos y confirmar denegación.
...
### QA-F12-003 — Superar el límite en rutas QR y verificar respuesta controlada sin afectar rutas internas.

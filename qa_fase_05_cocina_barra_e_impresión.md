# Plan de pruebas — Fase 5: Cocina, barra e impresión

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Monitor KDS, cambios de estado e impresión ESC/POS asíncrona.
...
### QA-F05-001 — Cambiar cada plato por los estados permitidos y rechazar transiciones inválidas.
...
### QA-F05-002 — Confirmar actualización inmediata en el monitor de cocina/barra.
...
### QA-F05-003 — Simular impresora caída y reconexión del agente sin bloquear la recepción de comandas.

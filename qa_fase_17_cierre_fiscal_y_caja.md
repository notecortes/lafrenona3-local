# Plan de pruebas — Fase 17: Cierre fiscal y caja

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Turnos de caja, Informe Z y cadena criptográfica fiscal.
...
### QA-F17-001 — Abrir caja, registrar operaciones y cerrar con efectivo esperado y contado.
...
### QA-F17-002 — Verificar cálculo SQL del Informe Z y tratamiento de descuadres.
...
### QA-F17-003 — Alterar un registro fiscal en clon de pruebas y detectar ruptura de la cadena hash.

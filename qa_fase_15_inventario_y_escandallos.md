# Plan de pruebas — Fase 15: Inventario y escandallos

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Ingredientes, recetas, consumo, coste y alertas de stock.
...
### QA-F15-001 — Completar el flujo principal de la fase desde la interfaz y validar la respuesta API.
...
### QA-F15-002 — Enviar datos inválidos, incompletos y no autorizados; verificar errores controlados.
...
### QA-F15-003 — Confirmar persistencia, aislamiento por restaurante y ausencia de regresiones visibles.

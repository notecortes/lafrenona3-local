# Plan de pruebas — Fase 16: Reservas y asignación

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Capacidad, disponibilidad, bloqueo anti-solapamiento y espera.
...
### QA-F16-001 — Reservar mesa disponible según capacidad y ventana temporal.
...
### QA-F16-002 — Enviar solicitudes concurrentes para la última mesa y garantizar una única asignación.
...
### QA-F16-003 — Enviar reserva a espera y sentarla después actualizando mesa y token de sesión.

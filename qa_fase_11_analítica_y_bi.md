# Plan de pruebas — Fase 11: Analítica y BI

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Métricas SQL, segmentación tenant y exportación CSV streaming.
...
### QA-F11-001 — Contrastar cada métrica contra consultas SQL de referencia.
...
### QA-F11-002 — Validar filtros de fecha, datos vacíos y aislamiento por restaurante.
...
### QA-F11-003 — Exportar volumen alto a CSV comprobando streaming y contenido correcto.

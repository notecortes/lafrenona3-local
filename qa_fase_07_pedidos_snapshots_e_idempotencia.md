# Plan de pruebas — Fase 7: Pedidos, snapshots e idempotencia

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Pedidos públicos, precio histórico, cierre y liberación de mesa.
...
### QA-F07-001 — Añadir artículos con una misma clave idempotente y comprobar que solo se persiste una vez.
...
### QA-F07-002 — Modificar después el precio del producto y comprobar que el pedido mantiene su snapshot.
...
### QA-F07-003 — Cerrar la comanda de forma atómica y liberar la mesa solo si la operación se completa.

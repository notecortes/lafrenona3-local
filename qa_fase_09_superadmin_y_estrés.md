# Plan de pruebas — Fase 9: SuperAdmin y estrés

## Objetivo

Validar que la fase cumple sus requisitos funcionales, técnicos, de seguridad y usabilidad. El alcance incluye: Administración global, suspensión, planes y carga concurrente.
...
### QA-F09-001 — Completar el flujo principal de la fase desde la interfaz y validar la respuesta API.
...
### QA-F09-002 — Enviar datos inválidos, incompletos y no autorizados; verificar errores controlados.
...
### QA-F09-003 — Confirmar persistencia, aislamiento por restaurante y ausencia de regresiones visibles.
